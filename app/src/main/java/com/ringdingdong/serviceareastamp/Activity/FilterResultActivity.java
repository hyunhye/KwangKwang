...
import com.ringdingdong.serviceareastamp.Service.FilterResultService;
...
public class FilterResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FilterResultService service = retrofit.create(FilterResultService.class);

        Call<List<SearchResultRepo>> repos = service.listRepos(Integer.toString(count),filter);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                // TODO : use item data.
                Intent intent = new Intent(FilterResultActivity.this, NearByTabActivity.class);
                intent.putExtra("service_area_name",name);
                SharedPreferences pref = FilterResultActivity.this.getSharedPreferences("pref", 0);
